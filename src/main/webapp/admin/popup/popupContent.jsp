...
<%-- 				<img src="${pageContext.request.contextPath}/admin/0.img/banner_icon.png"> --%>
				<div>빠른메뉴 :&nbsp;</div>
				<select class="popup-select popup-input-line" name="banner_menu1" id="banner_menu1" onchange="changeInformBox(1)">
...
<%-- 				<img src="${pageContext.request.contextPath}/admin/0.img/sales-icon.png" alt="이미지준비중"> --%>
				<div>상품명 :</div>
				<input class="banner-pdNameData popup-input-line" id="banner_text1" name="banner_text1" type="text">
				</div>
				<!-- 팝업(포스터) 이미지 설정 -->
				<div class="banner-td-2">
<%-- 				<img src="${pageContext.request.contextPath}/admin/0.img/fileDown.png" alt="이미지준비중"> --%>
	...
	<form action="BannerUploadC" id="bannerUploadForm1" method="post" enctype="multipart/form-data">
				...
				<input onchange="handleFileUpload(1)" hidden="" type="file" class="file_input" name="banner_thumbnail" id="thumbnail1">
