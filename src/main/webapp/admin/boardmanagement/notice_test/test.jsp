...
<html lang="kr">
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      //        let isAllowedKey = (e.key === 'Backspace' || e.key === 'Enter' || e.key === 'Delete' || e.key === 'ArrowUp' ||
      //                            e.key === 'ArrowDown');

      //        let isKoreanOrJapanese = (e.key >= '\u1100' && e.key <= '\uD7AF') || // 한글
      //                                 (e.key >= '\u3040' && e.key <= '\u30FF'); // 일본어 (

      //        if (isSelectedFigureExists && !isBeforeCaretExists && !isAfterCaretExists) {
      //        	(console.log('***위젯범위 탐지***'));
      //        }
