          ...
          <div class="header-td">
            <div class="header-td-menu">
              <div class="header-td-menu-title">
                <a href="" class=""
                  >소개 <span class="header-td-menu-under"></span>
                </a>
              </div>
              <div class="header-opmenu-td">
                <a class="header-opmenu-a" href="HC?link=1">회사소개</a>
                <a class="header-opmenu-a" href="HC?link=2">오시는길</a>
              </div>
            </div>
            <div class="header-td-menu">
              <div class="header-td-menu-title">
                <a href="" class=""
                  >소식 <span class="header-td-menu-under"></span>
                </a>
              </div>
              <div class="header-opmenu-td">
                <a class="header-opmenu-a" href="HC?link=3">공지사항</a>
                <a class="header-opmenu-a" href="HC?link=4">앨범</a>
                <a class="header-opmenu-a" href="HC?link=5">채용공고</a>
              </div>
            </div>
            <div class="header-td-menu">
              <div class="header-td-menu-title">
                <a href="" class=""
                  >서비스 <span class="header-td-menu-under"></span>
                </a>
              </div>
              <div class="header-opmenu-td">
                <a class="header-opmenu-a" href="HC?link=6">서비스안내</a>
                <a class="header-opmenu-a" href="HC?link=7">서비스신청</a>
              </div>
            </div>
            <div class="header-td-menu">
              <div class="header-td-menu-title">
                <a href="" class=""
                  >QnA <span class="header-td-menu-under"></span>
                </a>
              </div>
              <div class="header-opmenu-td">
      ...
      <div class="footer-tbl">
        <div class="footer-tr">
          ...
          <div class="footer-item-td-2">
            ...
            <div>
              代表社員 ： 大出 昭子
              <img src="user/0.img/footerinstaicon.png" alt="" />
