...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="${pageContext.request.contextPath}/user/introduce/employment/0.css/employment.css"
    />
  </head>
  <body>
    <div class="container">
        ...
        <div class="content-box-tr1">
          ...
          <div class="content-box-tr1-td2">
            ...
            <div class="content-box-tr1-td2-2">
              ...
              <div class="content-box-tr1-td2-2-4"><span>채용공고</span></div>
            </div>
          </div>
            ...
            <div class="content-box-tr1-td3-1">
              <div class="content-box-tr1-td3-1-1">
                ...
                <div class="content-box-tr1-td3-1-1-1">
                  ...
                  <div class="content-box-tr1-td3-1-1-1-3">
                  ...
                  <div class="content-box-tr1-td3-1-1-1-4">
                    <div class="content-box-tr1-td3-1-1-4-1">
                      ●모집대상 : 모집 시기 및 근무시간
                      <ul>
                        <li>
                          •연중
                    ...
                    <!-- 구분 -->
                    <div class="content-box-tr1-td3-1-1-4-2">
                      ●모집대상 : 모집 시기 및 근무시간
                      <ul>
                        <li>
                          •연중
                  ...
                  <div class="content-box-tr1-td3-1-1-1-5">
                    <div class="content-box-tr1-td3-1-1-1-5-1">
                      <div class="content-box-tr1-td3-1-1-1-5-1-1">
                        <div class="content-box-tr1-td3-1-1-1-5-1-1-1">
                          <div class="content-box-tr1-td3-1-1-1-5-1-1-1-1">
                            <!-- 여기안에 아이콘2개 문구하나 -->
                            <!-- 클립 -->
                            <div class="content-box-tr1-td3-1-1-1-5-1-1-1-1-1">
                              <img src="./0.img/clip_icon.png" alt="" />
                            </div>
                            <!-- 문구 -->
                            <div class="content-box-tr1-td3-1-1-1-5-1-1-1-1-2">
                              <span>履歴書.docx</span>
                            </div>
                            <!-- 다운로드 아이콘 -->
                            <div class="content-box-tr1-td3-1-1-1-5-1-1-1-3">
                              <a href=""
                      ...
                      <div class="content-box-tr1-td3-1-1-1-5-1-2">
                        <div class="content-box-tr1-td3-1-1-1-5-1-2-1">
                          <div class="content-box-tr1-td3-1-1-1-5-1-2-1-1">
                            <span>연락처</span>
                          </div>
                        </div>
                        <div class="content-box-tr1-td3-1-1-1-5-1-2-2">
                          <span>전화번호&nbsp:&nbsp06-6997-6531</span>
                        </div>
                        <div class="content-box-tr1-td3-1-1-1-5-1-2-3">
                          <span>FAX&nbsp:&nbsp06-6997-6520</span>
                        </div>
                        <div class="content-box-tr1-td3-1-1-1-5-1-2-4">
                          <span>휴대전화&nbsp:&nbsp090-8799-3855</span>
                        </div>
                        <div class="content-box-tr1-td3-1-1-1-5-1-2-5">
