                ...
                <div class="paging-div">
                  ...
                  <c:choose>
                    <c:when test="${curPageNo > 5}">
                      <a href="Announced_test_paging_C?p=${curPageNo - 5}">
                        <button><<</button>
                      </a>
                    </c:when>
                    <c:when test="${curPageNo <= 5 && curPageNo > 1}">
                      <a href="Announced_test_paging_C?p=1">
                        <button><<</button>
                      </a>
                    </c:when>
                    <c:otherwise>
                  ...
                  <c:choose>
                    <c:when test="${curPageNo > 1}">
                      <a href="Announced_test_paging_C?p=${curPageNo - 1}">
                        <button>이전</button>
                      </a>
                    </c:when>
                    <c:otherwise>
                  ...
                  >
                    ...
                    />
                    <a
                      href="Announced_test_paging_C?p=${pageNumber}"
                  ...
                  <c:choose>
                    ...
                    >
                      <a href="Announced_test_paging_C?p=${pageCount}">
                        <button>>></button>
                      </a>
                    </c:when>
                    <c:otherwise>
