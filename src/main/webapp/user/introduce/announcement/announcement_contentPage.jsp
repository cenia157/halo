        ...
        <div class="a_content-box-tr1">
            ...
            <div class="a_content-box-tr1-td2">
                <div class="a_content-box-tr1-td2-1">
                    <img src="user/0.img/home.png" width="1.7%" alt="" /> > 情報 > お知らせ
                </div>
            </div>
                        ...
                        <div class="a_content-box-tr1-td3-1-1-1">
                            ...
                            <c:forEach var="announcement" items="${announcements}">
                                <div class="a_content-box-tr1-td3-1-1-1-2">
                                    ...
                                    <div class="a_content-box-tr1-td3-1-1-1-2-3 title-width ancTitleDiv" data-anseq="${announcement.an_seq}">
                                    ...
                                    <div class="a_content-box-tr1-td3-1-1-1-2-5 reg-width">
                                        <span><fmt:formatDate value="${announcement.an_reg_date}" pattern="yyyy-MM-dd" /></span>
                                    </div>
                                </div>
                            </c:forEach>
                            <div class="paging-div">
                                ...
                                <c:forEach var="pageNumber" begin="${startPage}" end="${endPage}">
                                    <c:set var="currentPageClass" value="${pageNumber == curPageNo ? 'current-page' : ''}" />
                                    <a href="Announced_paging_C?p=${pageNumber}" class="page-number ${currentPageClass}">[${pageNumber}]</a>
                                </c:forEach>
                                <c:choose>
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${curPageNo + 5 > pageCount && curPageNo < pageCount}">
        ...
        <div class="modal-content">
            ...
            <div class="qd-content-box-td1-4">
                <div class="qd-content-box-td1-4-content">
                    ...
                    <span class="qd-content-box-td1-4-2" id="modalregDate">23-12-15</span>
                </div>
            </div>
            <div class="qd-content-box-td2-1">
                <div class="qd-content-box-td2-1-content" id="modalContent">
                    ...
                    어떤 혜택이나 특별한 안내사항이 있는지도 함께 알려주시면 감사하겠습니다 오버플로우 오토로 줬어요. <br />
                </div>
            </div>
            <div class="qd-content-box-td2-2">
                <button class="qd-content-box-td2-2-button" id="closeModalBtn">閉じる</button>
            </div>
        </div>
    </div>
</body>
