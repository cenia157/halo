...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/user/service/serviceApply/0.css/agree.css" />
</head>
<body>
			...
			<div class="content-step-page-td">
				...
				<p>
					<strong>料金体系:</strong>
					サービス料金は、提供時間に応じて設定されます。料金の詳細については、お問い合わせください。
				</p>
				<p>
				...
				<div class="checkbox-container">
					<label for="terms-agree">上記の事項に同意しました</label> <input
