...
<link
    ...
    />
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/user/service/serviceApply/0.css/nursingapply.css">
		...
		<div class="content-applyform-td">
			<div class="content-applyform-tr-1">
				<select class="categotyselect" name="category" id="category">
			           <option value="" selected="selected" disabled="disabled">‘방문요양’ 신청에 필요한 정보를 입력해주세요.</option>
			           <option value=""></option>
			           <option value=""></option>
			           <option value=""></option>
			    </select>
			...
			<div class="content-applyform-td2">
				...
				<div class="content-applyform-tr-2">
					<span class="content-applyform-tr-2-1">지역 (방문할 주소)* :</span>
					<input class="content-applyform-tr-2-2" type="text">
				</div>
				<div class="content-applyform-tr-2">
